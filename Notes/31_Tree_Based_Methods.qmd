...
cat("
Regression tree:
rpart(formula = Log_Salary ~ ., data = Hitters, control = rpart.control(xval = 10, 
    minbucket = 2, cp = 0))
...
```{r, echo=FALSE, fig.margin = FALSE, fig.fulwidth = TRUE, fig.height=6, fig.width=12, message=FALSE, warning=FALSE, fig.cap="Demonstration of GBM using simulated data and different number of B."}
library(gbm)
set.seed(1001)
x <- seq(-pi, pi, len = 501)
...
```{r, echo = FALSE, fig.cap = "Original tree", fig.align='center', out.width = "400px"}
knitr::include_graphics("img/8_12a.jpg")
```

```{r, echo = FALSE, fig.cap = "Same shape but different prediction tree", fig.align='center', out.width = "400px"}
knitr::include_graphics("img/8_12b.jpg")
```

```{r, echo = FALSE, fig.cap = "Pruned tree", fig.align='center', out.width = "400px"}
knitr::include_graphics("img/8_12c.jpg")
```

```{r, echo = FALSE, fig.cap = "Tree with additional branches", fig.align='center', out.width = "400px"}
